                            ...
                            <table class="table table-striped">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>2000$</td>
                                        <td>
                                            <div class="alert alert-primary px-4 py-0 m-0">Новый</div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>950$</td>
                                        <td>
                                            <div class="alert alert-success px-4 py-0 m-0" >Обработан</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">3</th>
                                        ...
                                        <td>5000$</td>
                                        <td>
                                            <div class="alert alert-warning px-4 py-0 m-0" >В обработке</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">4</th>
                                        ...
                                        <td>3000$</td>
                                        <td>
                                            <div class="alert alert-danger px-4 py-0 m-0" >Отмена</div>
                                        </td>
                                    </tr>
